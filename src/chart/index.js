...
const CandleChart = () => {
  ...
  const fetchApi = () =>{
    ...
    let queryParams = startTime ? `start=${startTime}&end=${currentTimeInMilliseconds}&limit=330`:`end=${currentTimeInMilliseconds}&limit=330`;

    fetch(`${baseUrl}${pathParams}?${queryParams}`, {mode: 'cors'})
      .then((response) => {
